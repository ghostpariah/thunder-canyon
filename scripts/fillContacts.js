...
function fillContactsNew(props) {
    //contacts,cust_ID,cusName,launcher
    ...
    $(addNewContactOption).on({
            ...
            switch (event.key) {
                ...
                case "Enter":
                    ...
                    if (contacts) {
                        ...
                        if (
                            addNewContactOption.getAttribute("data-cid") ==
                            "undefined"
                        ) {
                            console.log("is new company");
                            objContactProps.isNew = true;
                            //TODO: add new company to database
                            let decoded = removeSpecialCharacters(
                                document
                                    .getElementById("Customer-choice")
                                    .innerText.trim()
                            );
                            objContactProps.customer_ID =
                                addNewCompany(decoded);
                            ipc.send(
                                "pass-new-customer-to-main-window",
                                objContactProps.customer_ID
                            );
                            document
                                .getElementById("Customer-choice")
        ...
        mousedown: (event) => {
            ...
            if (contacts) {
                ...
                if (
                    addNewContactOption.getAttribute("data-cid") == "undefined"
                ) {
                    console.log("is new company");
                    objContactProps.isNew = true;
                    //TODO: add new company to database
                    ...
                    document
                        .getElementById("Customer-choice")
                        .setAttribute("data-cid", objContactProps.customer_ID);
                } else {
        ...
        for (i = 0; i < contacts.length; i++) {
            ...
            for (n in contacts[i].phonenumbers) {
                ...
                if (contacts[i].phonenumbers[n].number != null) {
                    ...
                    contactOption.setAttribute(
                        "method-ID",
                        `${contacts[i].phonenumbers[n].phone_ID}`
                    );
                    ...
                    $(contactOption).on({
                        click: (event) => {
                            ...
                            let ti = Number(
                                document
                                    .getElementById("Contacts-choice")
                                    .getAttribute("tabindex")
                            );
                            displayedName.innerHTML =
                                event.target.parentNode.firstChild.firstChild.innerHTML;
                            choice.innerHTML = event.target.innerHTML;
                            optionsBox.style.animationDuration = "300ms";
                            optionsBox.style.transform = "scaleY(0)";
                        ...
                        keydown: (event) => {
                            switch (event.key) {
                                ...
                                case "Tab":
                                    ...
                                    displayedName.innerHTML =
                                        contactOption.parentNode.firstElementChild.firstElementChild.innerHTML;
                                    choice.innerHTML = event.target.innerHTML;
                                    optionsBox.style.animationDuration =
                                        "300ms";
                                    optionsBox.style.transform = "scaleY(0)";
                                    chooseListItem(
                                        event,
                    ...
                    let contactOptionText = document.createTextNode(
                        contacts[i].phonenumbers[n].number
                    );
                ...
                if (contacts[i].emails[n].email != null) {
                    ...
                    $(contactOption).on({
                        click: (event) => {
                            ...
                            displayedName.innerHTML =
                                event.target.parentNode.firstChild.firstChild.innerHTML;
                            //event.target.previousSibling.childNodes[0].innerHTML;
                            choice.innerHTML = event.target.innerHTML;
                            optionsBox.style.animationDuration = "300ms";
                            optionsBox.style.transform = "scaleY(0)";
                            arrow.classList.remove("up");
