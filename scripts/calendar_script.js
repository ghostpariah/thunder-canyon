...
function fillDays(y) {
    ...
    for (i = 0; i < dim + daysAfter; i++) {
        ...
        var jd = jDate(
            m.toString() + "/" + dnumber.toString() + "/" + year.toString()
        );
        document
            .getElementById("dayBlock" + cell)
            .setAttribute("data-julian", jd);
        let h = hd.isHoliday(
            new Date(
                m.toString() + "/" + dnumber.toString() + "/" + year.toString()
            )
        ...
        if (h) {
            ...
            if (h[0].type == "public")
                eleHolidayBox.setAttribute("class", "holiday bank");
            document
                .getElementById("dayNumber" + cell)
                .appendChild(eleHolidayBox);
        }
        if (cell < daysInMonth(monthIndex, year) + daysBefore) {
            ...
            document
                .getElementById("dayNumber" + cell)
                .appendChild(txtDayNumber);

            //document.getElementById("dayNumber"+cell).innerHTML=i+1;
            document.getElementById("dayNumber" + cell).style.background =
                "white";
        } else {
            let txtDayNumber = document.createTextNode(
                i - daysInMonth(monthIndex, year) + 1
            );
            // document.getElementById("dayNumber"+cell).innerHTML=(h)
            // ?`${h[0].name} ${i-daysInMonth(monthIndex, year)+1}`
            // : i-daysInMonth(monthIndex, year)+1;
            document.getElementById("dayNumber" + cell).innerHTML =
                i - daysInMonth(monthIndex, year) + 1;
        ...
        am.ondblclick = function () {
            ...
            objCalData.date_scheduled = getFormattedDateString(
                year,
                this.parentNode.getAttribute("data-julian"),
                preview
            );
        ...
        for (j = 0; j < 6; j++) {
            ...
            var thisIndicator = document.getElementById(
                "indicatorAM" + jd + "_" + j
            );
...
function getScheduled() {
    ...
    for (member in allJobs) {
        allJobs[member].status == "sch" ||
        allJobs[member].comeback_customer == 1
            ? arrScheduledJobs.push(allJobs[member])
            : "";
    }
    console.log(arrScheduledJobs);
    for (i = 0; i < arrScheduledJobs.length; i++) {
        arrScheduledJobs[i].customer_name = ipc.sendSync(
            "db-get-customer-name",
            arrScheduledJobs[i].customer_ID
        );
    }
...
function countSchJobsForCalendar() {
    ...
    console.log(
        ...
        "days in month = " + daysInMonth(monthIndex, year),
        "daysAfter = " + daysAfter
    );
    ...
    for (i = 1; i <= daysInMonth(monthIndex, year) + daysAfter; i++) {
        for (j = 0; j < scheduledJobs.length; j++) {
            ...
            if (i <= daysInMonth(monthIndex, year)) {
                todaysJulianDate = jDate(
                    m.toString() + "/" + i.toString() + "/" + year.toString()
                );
            } else {
                let nd = i - dim;
                if (monthIndex < 11) {
            ...
            var isEligible =
                selectedYear == calYear || monthIndex == 11 ? true : false;
            console.log(todaysJulianDate);
            if (
                todaysJulianDate == scheduledJobs[j].julian_date &&
                isEligible
            ) {
                        ...
                        if (ampm == "am") {
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "1"
                            ).innerHTML = dayHolder[jd].am.checkallCount;
                        } else if (ampm == "pm") {
                            document.getElementById(
                                "indicator" +
                                    ampm.toUpperCase() +
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "1"
                            ).innerHTML = dayHolder[jd].pm.checkallCount;
                        } else if (ampm == "") {
                            document.getElementById(
                                "indicatorAM" + jd + "_" + "1"
                            ).style.visibility = "visible";
                        ...
                        if (ampm == "am") {
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "5"
                            ).innerHTML = dayHolder[jd].am.kingpinCount;
                        } else if (ampm == "pm") {
                            document.getElementById(
                                "indicator" +
                                    ampm.toUpperCase() +
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "5"
                            ).innerHTML = dayHolder[jd].pm.kingpinCount;
                        } else if (ampm == "") {
                            document.getElementById(
                                "indicatorAM" + jd + "_" + "5"
                            ).style.visibility = "visible";
                        ...
                        if (ampm == "am") {
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "3"
                            ).innerHTML = dayHolder[jd].am.frameCount;
                        } else if (ampm == "pm") {
                            document.getElementById(
                                "indicator" +
                                    ampm.toUpperCase() +
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "3"
                            ).innerHTML = dayHolder[jd].pm.frameCount;
                        } else if (ampm == "") {
                            document.getElementById(
                                "indicatorAM" + jd + "_" + "3"
                            ).style.visibility = "visible";
                        ...
                        if (ampm == "am") {
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "2"
                            ).innerHTML = dayHolder[jd].am.springCount;
                        } else if (ampm == "pm") {
                            document.getElementById(
                                "indicator" +
                                    ampm.toUpperCase() +
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "2"
                            ).innerHTML = dayHolder[jd].pm.springCount;
                        } else if (ampm == "") {
                            document.getElementById(
                                "indicatorAM" + jd + "_" + "2"
                            ).style.visibility = "visible";
                        ...
                        if (ampm == "am") {
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "4"
                            ).innerHTML = dayHolder[jd].am.alignmentCount;
                        } else if (ampm == "pm") {
                            document.getElementById(
                                "indicator" +
                                    ampm.toUpperCase() +
                            ...
                            document.getElementById(
                                "indicator" +
                                    ...
                                    "_" +
                                    "4"
                            ).innerHTML = dayHolder[jd].pm.alignmentCount;
                        } else if (ampm == "") {
                            document.getElementById(
                                "indicatorAM" + jd + "_" + "4"
                            ).style.visibility = "visible";
...
function setSelectedYear(incrementor) {
    ...
    var sYear = new Date(
        new Date().setFullYear(new Date().getFullYear() + incrementor)
    );
    ...
    for (i = 0; i < totalBlocks; i++) {
        ...
        db.onmouseenter = function (event) {
            ...
            let hasJobs = function () {
                ...
                if (validDay) {
                    for (
                        var grandChild = children[1].firstChild;
                        grandChild !== null;
                    ...
                    for (
                        var grandChild = children[2].firstChild;
                        grandChild !== null;
                        grandChild = grandChild.nextSibling
                    ) {
                        if (grandChild.style.visibility == "visible") {
...
function showJobs(e) {
    ...
    arrRightSide.includes(element.id.substring(8))
        ? schJobWallet.setAttribute("class", "jobWalletLeft speechArrowLeft")
        : schJobWallet.setAttribute("class", "jobWallet speechArrowRight");
...
function makeCalenderJobContainers(e) {
    ...
    for (j = 0; j < thisDaysSchJobs.length; j++) {
        ...
        let cnText = document.createTextNode(
            thisDaysSchJobs[j].customer_name.toUpperCase()
        );
        ...
        let unitText = thisDaysSchJobs[j].unit
            ? document.createTextNode(thisDaysSchJobs[j].unit.toUpperCase())
        ...
        let cuN =
            "<b class='customerName'>" +
            thisDaysSchJobs[j].customer_name.toUpperCase() +
            "</b><br/>";
        let u =
            thisDaysSchJobs[j].unit == null || thisDaysSchJobs[j].unit == ""
                ? ""
                : "<b>Unit: </b>" + thisDaysSchJobs[j].unit + "</br>";
...
function openContextMenu(e) {
    try {
        ...
        let thisDay = document
            .getElementById("jobWallet")
            .parentNode.id.substring(8);
            ...
            cmListItem.onclick = function (e) {
                ...
                switch (e.target.innerHTML) {
                    ...
                    case "EDIT":
                        ...
                        objJobInfo.customer_name = ipc.sendSync(
                            "db-get-customer-name",
                            objJobInfo.customer_ID
                        );
                        ipc.send(
                            "open-edit",
                            objJobInfo,
